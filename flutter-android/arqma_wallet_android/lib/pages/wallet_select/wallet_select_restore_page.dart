...
class _WalletSelectRestorePageState extends State<WalletSelectRestorePage>
  ...
  Future<void> _restore() async {
    ...
    if (walletBaseNameInputErrorKey(name) == 'invalid_chars') {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(loc.tr('pages.wallet_select.restore.invalid_account_name')),
        ),
      );
      return;
    }
      ...
      child: Column(
        ...
        children: [
          ...
          WalletRestoreRefreshControls(
            ...
            dateLabel: loc.tr('pages.wallet_select.restore.restore_date'),
            heightLabel: loc.tr(
            ...
            switchToDateLabel:
                loc.tr('pages.wallet_select.restore.switch_to_date_select'),
            onPickDate: () => _pickDate(loc),
          ...
          ArqmaField(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                hintStyle: const TextStyle(fontSize: 12, height: 1.2),
                hintMaxLines: 2,
                border: InputBorder.none,
              ),
