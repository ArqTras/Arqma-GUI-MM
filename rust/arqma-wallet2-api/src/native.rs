...
mod ffi {
  unsafe extern "C++" {
    ...
    fn wallet2_set_password(bridge: Pin<&mut Wallet2Bridge>, new_password: &CxxString) -> Result<bool>;
    fn wallet2_set_tx_note(bridge: Pin<&mut Wallet2Bridge>, txid: &CxxString, note: &CxxString) -> Result<bool>;
    ...
    fn wallet2_delete_address_book(bridge: Pin<&mut Wallet2Bridge>, row_id: u64) -> Result<bool>;
    fn wallet2_get_address_book_json(bridge: &Wallet2Bridge) -> Result<String>;
    fn wallet2_get_transfer_by_txid_json(bridge: &Wallet2Bridge, txid: &CxxString) -> Result<String>;
    ...
    fn wallet2_relay_tx_json(bridge: Pin<&mut Wallet2Bridge>, metadata_hex: &CxxString) -> Result<String>;
...
impl NativeWallet2Session {
  ...
  pub fn close (&mut self) -> Wallet2Result<()> {
    let mut b = self
      .bridge
      .pin_mut();
    ffi::wallet2_close(b.as_mut())
      .map_err(|e| Wallet2Error::OperationFailed(e.to_string()))
  }

  pub fn height (&self) -> Wallet2Result<u64> {
    ffi::wallet2_height(&self.bridge)
      .map_err(|e| Wallet2Error::OperationFailed(e.to_string()))
  }

  pub fn address (&self) -> Wallet2Result<String> {
    ffi::wallet2_address(&self.bridge)
      .map_err(|e| Wallet2Error::OperationFailed(e.to_string()))
  }

  pub fn seed (&self) -> Wallet2Result<String> {
    ffi::wallet2_seed(&self.bridge)
      .map_err(|e| Wallet2Error::OperationFailed(e.to_string()))
  }
