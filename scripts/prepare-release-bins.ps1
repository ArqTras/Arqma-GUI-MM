# Prepare build/flutter-desktop-bin/ for a bundled release (arqmad only in bin).
# Usage (repo root):
...
Write-Host "[prepare-release-bins] copy-to-flutter-desktop-bins.js..."
node (Join-Path $Root "build" "copy-to-flutter-desktop-bins.js")
