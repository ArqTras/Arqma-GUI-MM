...
- CI / native upstream: default **`ARQMA_UPSTREAM_REPO`** is **`https://github.com/arqma/arqma.git`** (main Arqma project); **`ARQMA_UPSTREAM_REF`** defaults to **`master`** (`build/ci/clone-arqma.sh`).
