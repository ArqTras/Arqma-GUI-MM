...
- **iOS:** TestFlight build **5.1.1 (18)** — fix password prompt when opening accounts (Face ID regression in build 17); Face ID / Touch ID unlock, background wallet sync, FFI **1.0.7**.
...
| **iOS** | `Arqma-Wallet-Mobile-5.1.1-ios-testflight.ipa` (or development IPA) | TestFlight / Xcode install per your signing profile; build **18** (password prompt fix). |
